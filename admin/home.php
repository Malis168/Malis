      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM returns WHERE date_return >= date_return";
                $query = $conn->query($sql);
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM borrow WHERE date_borrow = date_borrow and status = 0";
                $query = $conn->query($sql);
              ...
              <div class="col-xs-12">
                <div class="box">
                  <div class="box-header with-border">
                    <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat">Report</a>
                  </div>
                  <div class="box-body">
