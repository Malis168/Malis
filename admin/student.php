                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".$row['code']."</td>
                          <td>
                            <button class='btn btn-warning btn-sm edit' data-id='".$row['studid']."'><i class='fa fa-edit'></i></button>
                            <button class='btn btn-danger btn-sm delete' data-id='".$row['studid']."'><i class='fa fa-trash'></i></button>
                          </td>
                        </tr>
                      ";
                    }
