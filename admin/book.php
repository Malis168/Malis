          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                <thead>
                  <th  style="width: 60px;" class="text-center">Book ID</th>
                  <th class="text-center">Category</th>
                  <th style="width: 60px;" class="text-center">ISBN</th>
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".$status."</td>
                          <td>
                            <button class='btn btn-warning btn-sm edit' data-id='".$row['bookid']."'><i class='fa fa-edit'></i> </button>
                            <button class='btn btn-danger btn-sm delete' data-id='".$row['bookid']."'><i class='fa fa-trash'></i></button>
                          </td>
                        </tr>
                      ";
                    }
